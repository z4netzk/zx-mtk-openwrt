...
define Device/WT7981P
  DEVICE_VENDOR := MediaTek
  DEVICE_MODEL := WT7981P
  DEVICE_DTS := WT7981P
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  SUPPORTED_DEVICES := WT7981P
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 57354k
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += WT7981P

define Device/ZX7981PN
  DEVICE_VENDOR := MediaTek
  DEVICE_MODEL := ZX7981PN
  DEVICE_DTS := ZX7981PN
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  SUPPORTED_DEVICES := ZX7981PN
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 65536k
...
define Device/ZX7981E
  DEVICE_VENDOR := MediaTek
  DEVICE_MODEL := ZX7981E
  DEVICE_DTS := ZX7981E
  SUPPORTED_DEVICES := ZX7981E
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  DEVICE_PACKAGES := mkf2fs e2fsprogs blkid blockdev losetup kmod-fs-ext4 \
         kmod-mmc kmod-fs-f2fs kmod-fs-vfat kmod-nls-cp437 \
         kmod-nls-iso8859-1
