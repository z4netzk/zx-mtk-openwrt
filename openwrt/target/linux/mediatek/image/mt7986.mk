...
define Device/ZX7986P
  DEVICE_VENDOR := MediaTek
  DEVICE_MODEL := ZX7986P
  DEVICE_DTS := ZX7986P
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  SUPPORTED_DEVICES := ZX7986P
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  IMAGE_SIZE := 57354k
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += ZX7986P

define Device/ZX7986E
  DEVICE_VENDOR := MediaTek
  DEVICE_MODEL := ZX7986E
  DEVICE_DTS := ZX7986E
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  SUPPORTED_DEVICES := ZX7986E
  DEVICE_PACKAGES := mkf2fs e2fsprogs blkid blockdev losetup kmod-fs-ext4 \
         kmod-mmc kmod-fs-f2fs kmod-fs-vfat kmod-nls-cp437 \
         kmod-nls-iso8859-1
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += ZX7986E
